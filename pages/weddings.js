...
import { FaHeart, FaCamera, FaStar, FaCrown, FaMagic, FaInstagram, FaWhatsapp } from 'react-icons/fa'
...
export default function Weddings() {
  ...
  const specializations = [
    'צילום רומנטי מתקדם עם אפקטים מיוחדים',
    'אטרקציות אינטראקטיביות לזוגות',
    'הפקת וידאו מקצועית לכל החתונה',
    'תאורה רומנטית מתקדמת',
    'אטרקציות מותאמות אישית לזוג'
  ]

  const advantages = [
    'מבחר עצום של אטרקציות מתקדמות',
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-red-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl font-bold text-gray-700">טוען אטרקציות חתונה...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <>
      <Head>
        <title>אטרקציות חתונה - PhotoStyle</title>
        <meta name="description" content="אטרקציות צילום מתקדמות לחתונות - צוות מקצועי עם ניסיון של 10+ שנים" />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-red-50">
        ...
        <section className="relative py-20 sm:py-32 overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-pink-400/20 to-purple-400/20 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-gradient-to-tl from-red-400/20 to-pink-400/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-6">
              <FaHeart className="w-16 h-16 text-pink-500 mx-auto animate-pulse" />
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 mb-6 sm:mb-8">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 via-purple-600 to-red-600">
                אטרקציות חתונה
              </span>
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12">
              הופכים את היום המיוחד שלכם לחוויה בלתי נשכחת עם האטרקציות המתקדמות שלנו
            </p>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-8 max-w-4xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-lg text-center">
                <div className="text-2xl sm:text-4xl font-black text-pink-600 mb-1 sm:mb-2">200+</div>
                <div className="text-xs sm:text-base font-bold text-gray-600">חתונות מוצלחות</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-lg text-center">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-lg text-center">
                <div className="text-2xl sm:text-4xl font-black text-red-600 mb-1 sm:mb-2">100%</div>
                <div className="text-xs sm:text-base font-bold text-gray-600">זוגות מרוצים</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                אנו מתמחים ביצירת חוויות צילום ייחודיות ורומנטיות לחתונות
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              {specializations.map((spec, index) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-50 via-purple-50 to-red-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-r from-pink-600 via-purple-600 to-red-600 rounded-2xl flex items-center justify-center text-white shadow-lg mb-6 group-hover:scale-110 transition-transform duration-500">
                      <FaCamera className="w-8 h-8" />
                    </div>
                    <p className="text-gray-700 leading-relaxed font-medium">{spec}</p>
                  </div>

                  <div className="absolute top-4 right-4 w-2 h-2 bg-pink-400 rounded-full opacity-0 group-hover:opacity-70 animate-ping"></div>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Advantages Section */}
        <section className="py-16 sm:py-20 bg-gradient-to-r from-pink-600 via-purple-600 to-red-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-2xl">
              <div className="text-center mb-8 sm:mb-12">
                <div className="w-20 h-20 bg-gradient-to-r from-pink-600 via-purple-600 to-red-600 rounded-2xl flex items-center justify-center text-white mx-auto mb-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-6">
                    במשך יותר מ-10 שנים, הפכנו מאות חתונות לחוויות בלתי נשכחות. הצוות שלנו מתמחה בהתאמת האטרקציות המתקדמות ביותר לכל זוג ולכל סגנון חתונה.
                  </p>
                  <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-6">
                    אנחנו יודעים בדיוק איך להתאים את האטרקציות לאופי האירוע, לסגנון הזוג ולמקום האירוע כדי ליצור חוויה מושלמת שתזכר לעד.
                  </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-pink-100 to-purple-100 rounded-2xl p-6 flex flex-col justify-center items-center text-center h-full">
                    <div className="text-2xl font-black text-pink-600 mb-2">200+</div>
                    <div className="text-gray-700 font-bold">חתונות מוצלחות</div>
                  </div>
                  <div className="bg-gradient-to-br from-purple-100 to-red-100 rounded-2xl p-6 flex flex-col justify-center items-center text-center h-full">
                    <div className="text-2xl font-black text-purple-600 mb-2">15+</div>
                    <div className="text-gray-700 font-bold">אטרקציות מתקדמות</div>
                  </div>
                  <div className="bg-gradient-to-br from-red-100 to-pink-100 rounded-2xl p-6 flex flex-col justify-center items-center text-center h-full">
                    <div className="text-2xl font-black text-red-600 mb-2">10+</div>
                    <div className="text-gray-700 font-bold">שנות ניסיון</div>
                  </div>
                  <div className="bg-gradient-to-br from-pink-100 to-purple-100 rounded-2xl p-6 flex flex-col justify-center items-center text-center h-full">
                    <div className="text-2xl font-black text-pink-600 mb-2">100%</div>
                    <div className="text-gray-700 font-bold">זוגות מרוצים</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 sm:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                מגוון אטרקציות מתקדמות המותאמות במיוחד לחתונות
              </p>
            </div>
              ...
              {mainAttractions.map((attraction, index) => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-6">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 group-hover:text-pink-600 transition-colors duration-300">
                      {attraction.title}
                    </h3>
                  ...
                  {/* Floating elements */}
                  <div className="absolute top-2 left-2 w-2 h-2 bg-pink-400 rounded-full opacity-0 group-hover:opacity-70 animate-ping"></div>
        ...
        <section className="py-16 sm:py-20 bg-gradient-to-r from-pink-600 via-purple-600 to-red-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 sm:mb-12 max-w-2xl mx-auto">
              צרו איתנו קשר וקבלו הצעה מותאמת אישית לאטרקציות החתונה שלכם
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center gap-3 px-8 py-4 bg-white text-pink-600 font-bold rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300"
              >
